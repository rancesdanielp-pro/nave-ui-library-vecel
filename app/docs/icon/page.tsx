    ...
    >
      ...
      <ContentCards title="Icon Sizes">
        <p className="text-sm text-slate-500 mb-6">
          El componente utiliza la escala de tokens <code>icon.sizes</code> para
          mapear variantes (xs a xl) a valores numéricos, aplicándolos mediante
          la variable <code>--icon-size</code>.
        </p>
        <ComponentExample
          preview={
          ...
          code={`<div className="flex items-end justify-center gap-8">
                  <div className="flex flex-col items-center gap-2">
      ...
      <ContentCards title="Semantic Variants">
        <p className="text-sm text-slate-500 mb-6">
          La prop <code>color</code> resuelve la variante desde los tokens
          dinámicos. El componente inyecta <code>--icon-color</code> y los hijos
          SVG heredan este valor mediante <code>currentColor</code>.
        </p>
        <ComponentExample
          preview={
          ...
          code={`<div className="flex justify-center gap-10">
      ...
      <ContentCards title="IconLabel Composition">
        <p className="text-sm text-slate-500 mb-6">
          Abstracción para alinear iconos con texto. Utiliza <code>flex</code>{' '}
          para garantizar que el centro óptico del icono coincida con la línea
          de base del texto.
        </p>
        <ComponentExample
          preview={
      ...
      <div className="mt-16 border-t pt-10">
        ...
        <p className="text-sm text-slate-500 mb-6">
          El componente utiliza <code>React.cloneElement</code> para asegurar
          que el stroke y el tamaño se sincronicen con la variable CSS{' '}
          <code>--icon-size</code>.
        </p>

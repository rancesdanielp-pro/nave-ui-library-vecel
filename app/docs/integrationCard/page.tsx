    ...
    >
      ...
      <ContentCards title="Instalación">
        <p className="text-sm text-slate-500 mb-4">
          Importa el componente para presentar conexiones externas con una
          estética consistente y tematizable.
        </p>
        <CodeBlock
      ...
      <ContentCards title="Layout Standard (Small)">
        <p className="text-sm text-slate-500 mb-6">
          Diseño optimizado para grillas de alta densidad. Utiliza un contenedor
          de logotipo de 40x40px y una estructura vertical que prioriza la
          legibilidad de la descripción.
        </p>
        <ComponentExample
          preview={
      ...
      <ContentCards title="Layout Featured (Large)">
        <p className="text-sm text-slate-500 mb-6">
          Variante de alto impacto con banner superior de 140px. Diseñada para
          destacar integraciones premium o servicios destacados dentro del
          ecosistema.
        </p>
              ...
              <IntegrationCard
                ...
                logoSlot={
                  ...
                  >
                    ...
                    />
                    <path
                      d="M13.3356 8.5C10.5 8.5 8.5 10.5 8.5 13C8.5 15.5 10.5 17.5 13.3356 17.5C16.1712 17.5 18.1712 15.5 18.1712 13C18.1712 10.5 16.1712 8.5 13.3356 8.5Z"
                      fill="white"
                    />
                  </svg>
                }
      ...
      <ContentCards title="Variantes de Contorno">
        <p className="text-sm text-slate-500 mb-6">
          Controla la jerarquía visual del borde mediante el sistema de tokens
          de <code>integrationCard</code>.
        </p>
        <ComponentExample
          preview={
      ...
      <div className="mt-16 border-t pt-10">
        ...
        <p className="text-sm text-slate-500 mb-6">
          Configuración técnica del registro. Nota cómo las variables{' '}
          <code>--ic-title-color</code> y <code>--ic-link-color</code> permiten
          que los elementos internos reaccionen al cambio de tema global.
        </p>

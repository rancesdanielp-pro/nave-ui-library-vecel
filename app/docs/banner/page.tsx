...
import { Banner } from 'nave-ui-library/react'`}
      ...
      <ContentCards title="Semantic Tones">
        <p className="text-sm text-slate-500 mb-6">
          Utiliza los tonos para comunicar diferentes estados: éxito, advertencia, error o información.
        </p>
        <ComponentExample
          preview={
      ...
      <ContentCards title="Actions & Links">
        <p className="text-sm text-slate-500 mb-6">
          Los banners pueden contener acciones mediante links directos o funciones de callback.
        </p>
        <ComponentExample
          preview={
            <div className="flex flex-col gap-4 w-full">
          ...
          preview={
            <div className="flex flex-col gap-6 items-start w-full">
              <div className="w-full space-y-2">
                <span className="text-[10px] uppercase text-slate-400 font-bold">Full (Default)</span>
                <Banner tone="info" title="Banner de ancho completo" />
              </div>
              <div className="space-y-2">
                <span className="text-[10px] uppercase text-slate-400 font-bold">Compact</span>
                <Banner size="compact" tone="info" title="Banner compacto" />
              </div>
            </div>
          }
          code={`<Banner size="full" title="..." />\n<Banner size="compact" title="..." />`}
        />
      </ContentCards>
      ...
      <ContentCards title="Custom End Slots">
        <p className="text-sm text-slate-500 mb-6">
          Puedes inyectar cualquier componente en el extremo derecho usando la prop <code>endSlot</code>.
        </p>
        <ComponentExample
          preview={
            <Banner 
      ...
      <div className="mt-16 border-t pt-10">
        ...
        <p className="text-sm text-slate-500 mb-6">
          Configuración técnica del componente Banner, incluyendo el mapeo de colores para cada tono semántico.
        </p>
        <CodeBlock 

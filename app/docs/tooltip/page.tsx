    ...
    >
      ...
      <ContentCards title="Basic Usage">
        <p className="text-sm text-slate-500 mb-6">
          El Tooltip básico se activa al hacer hover sobre el trigger. Incluye
          una flecha posicionada automáticamente.
        </p>
        <ComponentExample
          preview={
      ...
      <ContentCards title="Sides & Positions">
        <p className="text-sm text-slate-500 mb-6">
          Puedes controlar la ubicación del contenido usando la propiedad{' '}
          <code>side</code>.
        </p>
        <ComponentExample
          preview={
          ...
          code={`<div className="grid grid-cols-2 gap-8 md:flex md:justify-center md:gap-12 p-10">
                  <Tooltip>
                    <TooltipTrigger asChild><Button variant="tertiary" size="small">Top</Button></TooltipTrigger>
                    <TooltipContent side="top">Tooltip arriba</TooltipContent>
                  </Tooltip>

                  <Tooltip>
                    <TooltipTrigger asChild><Button variant="tertiary" size="small">Bottom</Button></TooltipTrigger>
                    <TooltipContent side="bottom">Tooltip abajo</TooltipContent>
                  </Tooltip>

                  <Tooltip>
                    <TooltipTrigger asChild><Button variant="tertiary" size="small">Left</Button></TooltipTrigger>
                    <TooltipContent side="left">Tooltip izquierda</TooltipContent>
                  </Tooltip>

                  <Tooltip>
                    <TooltipTrigger asChild><Button variant="tertiary" size="small">Right</Button></TooltipTrigger>
                    <TooltipContent side="right">Tooltip derecha</TooltipContent>
                  </Tooltip>
                </div>
            `}
      ...
      <ContentCards title="Rich Triggers">
        <p className="text-sm text-slate-500 mb-6">
          Los Tooltips pueden envolver cualquier componente, como Avatares para
              ...
              <div className="flex items-center gap-1 text-slate-400">
                ...
                <Tooltip>
                  ...
                  <TooltipContent className="max-w-[200px]">
                    Tus datos están protegidos con encriptación de grado
                    bancario.
                  </TooltipContent>
                </Tooltip>
              </div>
      ...
      <div className="mt-16 border-t pt-10">
        ...
        <p className="text-sm text-slate-500 mb-6">
          El Tooltip utiliza Radix UI para la gestión de portales y
          accesibilidad. Los estilos de la flecha (`Arrow`) se sincronizan
          automáticamente con el color de fondo del contenido.
        </p>

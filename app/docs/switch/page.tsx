    ...
    >
      ...
      <ContentCards title="Basic Usage">
        <p className="text-sm text-slate-500 mb-6">
          El Switch puede utilizarse solo o acompañado de etiquetas y
          descripciones para dar contexto a la acción.
        </p>
        <ComponentExample
          preview={
      ...
      <ContentCards title="States">
        <p className="text-sm text-slate-500 mb-6">
          Soporta estados deshabilitados tanto para la variante activa como
          inactiva.
        </p>
        <ComponentExample
          preview={
            <div className="flex flex-col md:flex-row gap-12 justify-center">
              <div className="space-y-4">
                <span className="text-[10px] uppercase text-slate-400 font-bold italic">
                  Disabled Off
                </span>
      ...
      <ContentCards title="Sizes">
        <p className="text-sm text-slate-500 mb-6">
          Disponible en tamaños <code>medium</code> y <code>small</code> para
          adaptarse a diferentes densidades de interfaz.
        </p>
        <ComponentExample
          preview={
      ...
      <div className="mt-16 border-t pt-10">
        ...
        <p className="text-sm text-slate-500 mb-6">
          Metadatos técnicos. El componente utiliza Radix UI Switch Primitive y
          gestiona las transiciones de color y posición mediante tokens.
        </p>

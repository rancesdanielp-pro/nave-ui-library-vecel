    ...
    >
      ...
      <ContentCards title="Basic Usage">
        <p className="text-sm text-slate-500 mb-6">
          El componente muestra dos métricas principales (monto y conteo) dentro
          de una tarjeta con un selector de fecha integrado.
        </p>
        <ComponentExample
          preview={
      ...
      <ContentCards title="Loading State">
        <p className="text-sm text-slate-500 mb-6">
          Utiliza la prop <code>state="loading"</code> junto con{' '}
          <code>loadingContent</code> para mostrar un estado de carga (ej.
          Skeletons).
        </p>
        <ComponentExample
          preview={
          ...
          code={`<div className="w-full max-w-sm mx-auto">
              <UnknownPurchase 
                title="Compras desconocidas"
                totalAmount=""
                totalCount={0}
      ...
      <ContentCards title="Empty State">
        <p className="text-sm text-slate-500 mb-6">
          Cuando no hay datos para el periodo seleccionado, usa{' '}
      ...
      <ContentCards title="Error State">
        <p className="text-sm text-slate-500 mb-6">
          Maneja fallos en la red o en el servidor mediante{' '}
      ...
      <ContentCards title="Estructura y Estilos">
        <div className="space-y-4">
          <p className="text-sm text-slate-600">
            Este organismo utiliza una arquitectura basada en estados para
            gestionar su ciclo de vida sin necesidad de manejar lógica interna:
          </p>
          <ul className="list-disc list-inside text-sm text-slate-500 space-y-2">
            <li>
              <strong>Gestión de Estados:</strong> Soporta los estados{' '}
              <code>default</code>, <code>loading</code>, <code>empty</code> y{' '}
              <code>error</code>.
            </li>
            <li>
              <strong>Slots Dinámicos:</strong> Permite inyectar cualquier nodo
              de React mediante props de contenido para una personalización
              total de la UI de carga y error.
            </li>
            <li>
              <strong>Tipografía de Datos:</strong> Los valores numéricos
              utilizan <code>text-xl font-semibold</code> para destacar en el
              estado por defecto.
            </li>
            <li>
              <strong>Selector de Fecha:</strong> El <code>Button</code>{' '}
              disparador mantiene la coherencia visual con un tracking de{' '}
              <code>-0.04em</code>.
            </li>
          </ul>
        </div>

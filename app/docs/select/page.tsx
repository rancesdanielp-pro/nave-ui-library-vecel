...
import { Select } from 'nave-ui-library/react'`} 
      ...
      <ContentCards title="Basic Usage">
        <p className="text-sm text-slate-500 mb-6">
          El Select requiere un array de objetos <code>items</code> con las propiedades <code>label</code> y <code>value</code>.
        </p>
        <ComponentExample
          preview={
      ...
      <ContentCards title="Sizes">
        <p className="text-sm text-slate-500 mb-6">
          Soporta tres tamaños predefinidos: <code>sm</code> (32px), <code>default</code> (40px) y <code>lg</code> (48px).
        </p>
        <ComponentExample
          preview={
            <div className="flex flex-col gap-6 w-full max-w-[240px]">
              <div className="space-y-1.5">
                <span className="text-[10px] uppercase text-slate-400 font-bold">Small (32px)</span>
                <Select size="sm" items={countryItems} placeholder="Pequeño" />
              </div>
              <div className="space-y-1.5">
      ...
      <ContentCards title="Theming">
        <p className="text-sm text-slate-500 mb-6">
          El Select utiliza <code>resolveTokens</code> para sincronizar el fondo del dropdown y los bordes con tu sistema de diseño.
        </p>
        <div className="space-y-4">
          <ul className="list-disc list-inside text-sm text-slate-600 space-y-2">
            <li><strong>Dropdown Background:</strong> Controlado por <code>dropdownBackground</code> en los tokens.</li>
            <li><strong>Border Radius:</strong> Se hereda de los estilos base del componente.</li>
            <li><strong>Indicator:</strong> Muestra un icono de <code>Check</code> automáticamente en el ítem activo.</li>
          </ul>
        </div>
      </ContentCards>

...
import { PromoBanner } from 'nave-ui-library/react'`} 
      ...
      <ContentCards title="Default (Image Right)">
        <p className="text-sm text-slate-500 mb-6">
          La posición por defecto de la imagen es a la derecha, optimizada para tarjetas promocionales estándar.
        </p>
        <ComponentExample
          preview={
      ...
      <ContentCards title="Image Position">
        <p className="text-sm text-slate-500 mb-6">
          Puedes alternar la posición de la imagen entre <code>left</code> y <code>right</code>.
        </p>
        <ComponentExample
          preview={
          ...
          code={`<PromoBanner imagePosition="left" ... />\n<PromoBanner imagePosition="right" ... />`}
        />
      </ContentCards>
      ...
      <ContentCards title="Visual Variants">
        <p className="text-sm text-slate-500 mb-6">
          El componente permite extender estilos mediante <code>variants</code> si están definidos en los tokens.
        </p>
        <ComponentExample
          preview={
          ...
          code={`<PromoBanner variant="primary" ... />\n<PromoBanner variant="secondary" ... />`}
        />
      </ContentCards>
      ...
      <ContentCards title="Text Truncation">
        <p className="text-sm text-slate-500 mb-6">
          El componente limita automáticamente el texto a 2 líneas para mantener la consistencia visual.
        </p>
        <ComponentExample
          preview={
            <div className="flex justify-center w-full">
          ...
          code={`<PromoBanner \n  title="Este es un título extremadamente largo..." \n  imageSrc="..." \n/>`}
        />
      </ContentCards>

...
import { Button, Navbar } from '@/packages/ui-library/dist/react';
...
import { Separator } from '@/packages/ui-library/dist/react';
    ...
    >
      ...
      <ContentCards title="Instalación e Importación">
        <p className="text-sm text-slate-600 mb-4">
          La <code>Navbar</code> es un componente compuesto. Asegúrate de tener
          instaladas las dependencias que utilices ejemplo: <b>Button</b> para su correcto funcionamiento.
        </p>
        <CodeBlock
          code={`import 'nave-ui-library/styles.css'; 
                 import { Navbar, Button } from 'nave-ui-library/react';
            `}
        />
      </ContentCards>
      ...
      <ContentCards title="Vista Previa en Vivo">
        <p className="text-sm text-slate-500 mb-6 italic">
          Nota: El selector de la izquierda cambiará el estado local de la
          documentación.
        </p>
        <ComponentExample
          preview={
            <div className="w-full bg-slate-100/50 p-8 rounded-xl border border-dashed border-slate-300">
              <Navbar>
                ...
                <Navbar.End>
                  <Navbar.Slot>
                    <Button variant="secondary" startIcon={<Wallet />}>
                      Cobrar
                    </Button>
                  </Navbar.Slot>

                  <Navbar.Slot>
                    <Navbar.User user={mockUser} />
                  </Navbar.Slot>
                </Navbar.End>
              </Navbar>
            </div>
          }
          code={`const [merchantId, setMerchantId] = useState('1'); <Navbar>
                <Navbar.Start>
                  <Navbar.Logo></Navbar.Logo>
                  <Separator orientation="vertical" />
                  <Navbar.Merchant
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-slate-600">
              El componente detecta automáticamente el número de comercios. Si
              hay <b>más de uno</b>, renderiza un Dropdown. Si hay{' '}
              <b>solo uno</b>, muestra el nombre como texto estático.
            </p>
            <div className="bg-slate-50 p-4 rounded-lg border border-slate-100">
              <CodeBlock
                code={`merchants: Merchant[] {  id: '1', name: 'Nave Coffee'}`}
              />
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-slate-600">
              Requiere un objeto <code>user</code> que incluya un array{' '}
              <code>menu</code>. El componente gestiona internamente el
              renderizado del Avatar y el Dropdown.
            </p>
            <div className="bg-slate-50 p-4 rounded-lg border border-slate-100">
              <CodeBlock
                code={`user: NavbarUser { name: 'Rodrigo', role: 'Admin', menu: [{ label: 'Salir', onClick: fn }]}`}
              />
            </div>
          </div>
        </div>
          ...
          <table className="w-full text-left text-sm border-collapse">
            ...
            <tbody className="text-slate-600">
              <tr className="border-b border-slate-50">
                <td className="py-3 px-3 font-mono text-xs text-purple-600 font-bold">
                  merchants
                </td>
                <td className="py-3 px-3 text-xs italic">Merchant[]</td>
                <td className="py-3 px-3">
                  Lista de comercios disponibles para el usuario.
                </td>
              </tr>
              <tr className="border-b border-slate-50">
                <td className="py-3 px-3 font-mono text-xs text-purple-600 font-bold">
                ...
                <td className="py-3 px-3">
                  ID del comercio seleccionado actualmente.
                </td>
              </tr>
              <tr className="border-b border-slate-50">
                <td className="py-3 px-3 font-mono text-xs text-purple-600 font-bold">
                ...
                <td className="py-3 px-3">
                  Botones de acción rápida (Ayuda, Notificaciones, etc).
                </td>
              </tr>
              <tr>
                <td className="py-3 px-3 font-mono text-xs text-purple-600 font-bold">
                ...
                <td className="py-3 px-3">
                  Datos del usuario y las opciones de su menú personal.
                </td>
              </tr>
            </tbody>
          </table>
      ...
      <div className="mt-16 border-t pt-10">
        <h2 className="text-xl font-bold mb-4 text-slate-900 italic tracking-tighter">
          Metadata del Componente (Registry)
        </h2>

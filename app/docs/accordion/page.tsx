    ...
    >
      ...
      <ContentCards title="Imports">
        <CodeBlock
          code={`import 'nave-ui-library/styles.css'
                 import {Accordion, AccordionItem, AccordionTrigger, AccordionContent  } from 'nave-ui-library/react'`}
        />
      </ContentCards>
      ...
      <ContentCards title="Basic Usage">
        <p className="text-sm text-slate-500 mb-6">
          Por defecto, el acordeón permite abrir una sección a la vez. El
          contenedor mantiene un ancho constante para evitar saltos visuales.
        </p>
        <ComponentExample
          preview={
              ...
              <Card title="Ayuda y Soporte" className="w-full">
                ...
                >
                  <AccordionItem value="item-1">
                    ...
                    <AccordionContent>
                      Aceptamos todas las tarjetas de crédito y débito. Los
                      pagos se procesan de forma instantánea a través de nuestra
                      pasarela segura.
                    </AccordionContent>
                  </AccordionItem>
                  <AccordionItem value="item-2">
                    ...
                    <AccordionContent>
                      No, solo pagas una comisión por cada venta realizada. No
                      hay costos fijos mensuales ni sorpresas.
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
              </Card>
      ...
      <ContentCards title="Rich Content Trigger Size: sm">
        <p className="text-sm text-slate-500 mb-6">
          Los triggers pueden contener estructuras complejas. El ancho se
          mantiene idéntico en estado abierto y cerrado.
        </p>
        <ComponentExample
          preview={
              ...
              <Card title="Seguridad de Cuenta" className="w-full">
                <Accordion type="multiple" className="w-full" size="sm">
                  <AccordionItem value="security">
                    ...
                    <AccordionContent>
                      La autenticación por huella o rostro añade una capa extra
                      de protección a tus transacciones diarias.
                    </AccordionContent>
                  </AccordionItem>
                  <AccordionItem value="limits">
                    ...
                    <AccordionContent>
                      Tu límite actual es de $500.000. Puedes solicitar un
                      aumento adjuntando documentación adicional.
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
              </Card>
      ...
      <ContentCards title="Consistencia Visual">
        <div className="space-y-4">
          <p className="text-sm text-slate-600">
            Para asegurar que el componente no "baile" o cambie de tamaño al
            colapsar:
          </p>
          <ul className="list-disc list-inside text-sm text-slate-500 space-y-2">
            <li>
              <strong>Ancho Fijo (Container):</strong> Se utiliza{' '}
              <code>max-w-2xl</code> en el wrapper para definir el ancho máximo
              de la <code>Card</code>.
            </li>
            <li>
              <strong>W-Full:</strong> Tanto la <code>Card</code> como el{' '}
              <code>Accordion</code> usan <code>w-full</code> para estirarse
              hasta el límite del contenedor.
            </li>
            <li>
              <strong>Flexbox:</strong> El trigger usa{' '}
              <code>justify-between</code> para que el chevron siempre esté en
              el extremo derecho, sin importar si el acordeón está abierto o
              cerrado.
            </li>
          </ul>
        </div>
